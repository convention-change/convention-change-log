# This dockerfile uses extends image https://hub.docker.com/sinlov-go/convention-change-log
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/convention-change-log
